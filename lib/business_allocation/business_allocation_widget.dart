...
class BusinessAllocationWidget extends StatefulWidget {
  const BusinessAllocationWidget({Key key}) : super(key: key);

  @override
  _BusinessAllocationWidgetState createState() =>
      _BusinessAllocationWidgetState();
}

class _BusinessAllocationWidgetState extends State<BusinessAllocationWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'businessAllocation'});
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            logFirebaseEvent('BUSINESS_ALLOCATION_chevron_left_ICN_ON_');
                  ...
                  children: [
                    Container(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'BUSINESS_ALLOCATION_PAGE_SAVE_BTN_ON_TAP');
                          ...
                          final dailyFinancialTransactionCreateData =
                            ...
                            isMoneyOut: false,
                            description: 'Add fund to business account',
                            spendAt: 'Add Fund',
                          );
