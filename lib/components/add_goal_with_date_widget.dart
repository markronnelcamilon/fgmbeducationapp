                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: () async {
                        logFirebaseEvent(
                            'ADD_GOAL_WITH_DATE_Container_ycuuljlf_ON');
                    ...
                    child: Row(
                      ...
                      children: [
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'ADD_GOAL_WITH_DATE_CANCEL_BTN_ON_TAP');
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'ADD_GOAL_WITH_DATE_COMP_ADD_BTN_ON_TAP');
                            logFirebaseEvent('Button_Backend-Call');

                            final goalListCreateData = createGoalListRecordData(
                              userID: currentUserUid,
                              date: datePicked,
                              goalID:
                                  '${widget.userID}${dateTimeFormat('yMd', datePicked)}',
                            );
                            await GoalListRecord.collection
                                .doc()
                                .set(goalListCreateData);
                            logFirebaseEvent('Button_Navigate-Back');
                            Navigator.pop(context);
                          },
                          text: 'Add',
