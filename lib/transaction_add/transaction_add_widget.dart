...
class _TransactionAddWidgetState extends State<TransactionAddWidget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'transaction_add'});
    ...
    return StreamBuilder<List<DailyFinancialPlannerRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        final transactionAddDailyFinancialPlannerRecord =
            transactionAddDailyFinancialPlannerRecordList.isNotEmpty
                ? transactionAddDailyFinancialPlannerRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
            ...
            leading: InkWell(
              onTap: () async {
                logFirebaseEvent('TRANSACTION_ADD_Icon_p0277sqb_ON_TAP');
