    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'privacy':
          ...
          break;
        case 'storyEndAt':
          result.storyEndAt = serializers.deserialize(value,
              specifiedType: const FullType(DateTime)) as DateTime?;
          break;
        case 'dayCompleted':
          result.dayCompleted = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool?;
          break;
...
class _$UserStoriesRecord extends UserStoriesRecord {
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'UserStoriesRecord')
          ...
          ..add('isOwner', isOwner)
          ..add('privacy', privacy)
          ..add('storyEndAt', storyEndAt)
          ..add('dayCompleted', dayCompleted)
          ..add('ffRef', ffRef))
        .toString();
  }
}
...
class UserStoriesRecordBuilder
  ...
  DateTime? _storyEndAt;
  DateTime? get storyEndAt => _$this._storyEndAt;
  set storyEndAt(DateTime? storyEndAt) => _$this._storyEndAt = storyEndAt;

  bool? _dayCompleted;
  bool? get dayCompleted => _$this._dayCompleted;
  set dayCompleted(bool? dayCompleted) => _$this._dayCompleted = dayCompleted;
  ...
  UserStoriesRecordBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _isOwner = $v.isOwner;
      _privacy = $v.privacy;
      _storyEndAt = $v.storyEndAt;
      _dayCompleted = $v.dayCompleted;
      _ffRef = $v.ffRef;
      _$v = null;
    }
    return this;
